...
local function get_groups()
  ...
  local groups = {
    ...
    -- StatusLine = { fg = '#152b40', bg = '#80a0ff', reverse = config.inverse },
    StatusLineNC = { fg = colors.bg1, bg = colors.fg4, reverse = config.inverse },
    Statusmode = { bg = '#80a0ff', bold = config.bold, reverse = config.inverse },
    Statusfilename = { bold = config.bold, reverse = config.inverse },
    Statusmodified = { bold = config.bold, reverse = config.inverse },
